-- Private Instagram follow proof for free selection registrations.
-- Existing JSON registrations remain compatible: the new RPC parameter defaults to NULL.
-- Rollback: supabase/rollback/20260929010000_instagram_proof.down.sql

alter table public.registrations
  add column if not exists instagram_proof_path text;

insert into storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
values ('instagram-proofs', 'instagram-proofs', false, 2097152,
